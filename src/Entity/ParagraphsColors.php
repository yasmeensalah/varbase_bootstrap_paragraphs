...
namespace Drupal\varbase_bootstrap_paragraphs\Entity;
 ...
 *
 * @ConfigEntityType(
 *   id = "paragraphs_colors",
 *   label = @Translation("Paragraphs colors"),
 *   handlers = {
 *     "list_builder" = "Drupal\varbase_bootstrap_paragraphs\Controller\ParagraphsColorListBuilder",
 *   },
 *   config_prefix = "paragraphs_color",
 ...
 * )
 */
class ParagraphsColors extends ConfigEntityBundleBase implements EntityWithPluginCollectionInterface {

  /**
   * The ParagraphsColor ID.
   *
   * @var string
   */
  public $id;
